<footer class="footer" role="contentinfo">
    ...
    <ul class="nav">
        ...
        <ul class="footer--nav">
            ...
            <div class="reseaux">
                <a class="reseaux__lien" href="#"><img class="reseaux_img" src="<?php echo $niveau;?>images/reseaux/facebook.svg" alt="facebook"></a>
                <a class="reseaux__lien" href="#"><img class="reseaux_img" src="<?php echo $niveau;?>images/reseaux/twitter.svg" alt="twitter"></a>
                <a class="reseaux__lien" href="#"><img class="reseaux_img" src="<?php echo $niveau;?>images/reseaux/youtube.svg" alt="youtube"></a>
            </div>
        </div>
